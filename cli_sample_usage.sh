...
dm raw-state $APP_ID_1

echo "7. Print data file for $APP_ID_1"
dm raw-data $APP_ID_1
...
dm raw-state --no-ensure-alive $APP_ID_1

echo "16. Check raw-state of $APP_ID_2 with    --no-ensure-alive"
dm raw-state --no-ensure-alive $APP_ID_2 
